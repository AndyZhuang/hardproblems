...
export const PROBLEMS = [
  ...
  },
  {
    ...
    tags: ['隐私', '密码学', 'AI'],
    videoUrl: 'https://www.youtube.com/embed/feature_video_placeholder',
    videoTitle: 'Data Privacy',
    videoChannel: 'Computerphile',
    participate: [{ type: 'code', label: '写代码/算法', desc: '差分隐私库实现' }, { type: 'essay', label: '写文章/论文', desc: '介绍 GDPR 与个保法' }, { type: 'kid-project', label: '儿童项目', desc: '教小朋友密码学基础' }]
  },
  {
  ...
  },
  {
    ...
    tags: ['人口', '健康', '经济'],
    videoUrl: 'https://www.youtube.com/embed/feature_video_placeholder',
    videoTitle: 'Aging Population',
    videoChannel: 'Kurzgesagt',
    participate: [{ type: 'community', label: '社区/组织', desc: '陪伴独居老人' }, { type: 'data', label: '数据收集/标注', desc: '收集身边老人生活状况数据' }, { type: 'essay', label: '写文章/论文', desc: '介绍 HALE 指标' }]
  },
  {
    id: 'education-access',
    category: 'social',
  ...
  },
  {
    ...
    tags: ['数字', '公平', 'AI'],
    videoUrl: 'https://www.youtube.com/embed/feature_video_placeholder',
    videoTitle: 'Digital Divide',
    videoChannel: 'Kurzgesagt',
    participate: [{ type: 'community', label: '社区/组织', desc: '教长辈用智能手机' }, { type: 'code', label: '写代码/算法', desc: '无障碍网页工具' }, { type: 'essay', label: '写文章/论文', desc: '介绍 ITU IDI 指数' }]
  },
  {
    id: 'levy-cuckoo',
    category: 'mathematics',
