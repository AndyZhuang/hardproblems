...
add(
    ...
    formal='设计一种催化剂在 ≤ 100°C 和 ≤ 10 atm 下实现高转化率氨合成。',
...
add(
    ...
    formal='实现 < 50 美元/吨的 CO₂ 捕集且能耗 < 2 GJ/吨。',
...
add(
    ...
    formal='为任意目标几何/化学功能设计稳定、可溶、高活性的新蛋白质。',
...
add(
    ...
    formal='开发 < 100 mV 过电位下 10 mA/cm² 且 1000 小时稳定的 OER/HER 催化剂。',
...
add(
    ...
    formal='开发 > 50% 法拉第效率、> 1000 小时稳定的 CO₂-to-液体燃料 催化剂。',
...
add(
    ...
    formal='实现 > 1000 Wh/kg 实际能量密度、> 500 次循环的 Li-air 电池。',
...
add(
    ...
    formal='> 99.9% 纯度、< 5% 缺陷率、< 100 美元/公斤 的碳纳米管生产。',
    whyHard='生长动力学和催化剂控制。',
...
add(
    ...
    formal='> 1 m 直径、< 10 Ω/sq 电阻、< 100 美元/m² 的石墨烯薄膜生产。',
    whyHard='晶界、缺陷控制。',
...
add(
    ...
    formal='实现 > 10% 太阳能到燃料能量转换效率且稳定运行 > 1000 小时。',
...
add(
    ...
    formal='> 500 Wh/kg、> 1000 次循环的锂硫电池。',
...
add(
    ...
    formal='实现哺乳动物（线虫→果蝇→小鼠→人）完整大脑的连接组重建和功能模拟。',
...
add(
    ...
    formal='通过 RuBisCO 工程 / C4 通路 / 光呼吸消除提升光合效率。',
    whyHard='多基因协调。',
...
add(
    ...
    formal='对真实规模的工业代码（10⁵-10⁷ 行）实现全自动验证。',
    whyHard='状态空间爆炸。',
...
add(
    ...
    formal='实现 > 10000 TPS 的去中心化区块链且不牺牲安全性。',
...
add(
    ...
    formal='> 10x GPU 的能效比（TOPS/W）且能跑现代 AI 模型。',
    whyHard='硬件和软件协同设计。',
...
add(
    ...
    formal='实现 100 TB/s 内存带宽的 3D 堆叠芯片。',
    whyHard='散热和良率。',
...
add(
    ...
    formal='> 100x 现有 AI 模型的能效（按 FLOP/W 衡量）。',
    whyHard='架构、算法、硬件协同。',
...
add(
    ...
    formal='实现 > 36000 km 长度、> 60 GPa 强度、< 1.3 g/cm³ 密度的缆绳材料。',
...
add(
    ...
    formal='> 10% 太阳能-燃料效率、> 1000 小时稳定的人造叶子。',
    whyHard='催化剂稳定性和效率。',
...
add(
    ...
    formal='> 7% 重量密度、可逆循环 > 500 次、安全且廉价的常温常压储氢。',
...
add(
    ...
    formal='> 1000 公斤/年从小行星运回地球的成本 < 100 万美元。',
    whyHard='空间推进和自主机器人。',
...
add(
    ...
    formal='> 0.5 mm 宽裂缝完全自修复、寿命延长 50%。',
    whyHard='细菌存活和活性控制。',
...
add(
    ...
    formal='> 在 5 项感官测试中让 80% 消费者分不清真假。',
    whyHard='复杂肌肉纤维结构。',
...
add(
    ...
    formal='> 10 吨/天 工厂级、< 1 美元/公斤 处理成本。',
    whyHard='酶活性和稳定性。',
...
add(
    ...
    formal='> 在所有合法路况、所有天气下不需人接管的自动驾驶。',
    whyHard='长尾事件、伦理。',
...
add(
    ...
    formal='> 50 公里半径、< 1 小时送达、< 5 美元/单的无人机物流。',
    whyHard='空中管制、载荷。',
...
add(
    id='misinformation', category='social',
    title='打击虚假信息', titleEn='Fight Misinformation',
    year=2016, proposer='—', difficulty=4, reward=2000, status='open',
    summary='让真相在网上更容易被发现',
    kid='网上谣言、假新闻、深度伪造……人们越来越分不清真假。怎么在不变成"控制思想"的情况下，让大家更容易看到真相？',
    formal='> 显著降低社交媒体上假信息的传播率且不损害言论自由。',
    whyHard='审查 vs 自由的张力。',
    aiPrompt='介绍事实核查、深度伪造检测、媒体素养。',
    tags=['媒体', '社会', 'AI'],
    videoUrl='https://www.youtube.com/embed/feature_video_placeholder', videoTitle='Misinformation', videoChannel='Kurzgesagt',
    participate=part(('code','假新闻检测模型'),
                  ('community','社区事实核查'),
                  ('essay','介绍虚假信息研究'))
)
...
add(
    ...
    formal='> AI 个性化教学效果等于或超过 1 对 1 教师。',
    whyHard='情绪识别、知识表征。',
...
add(
    ...
    formal='> 长期大规模 UBI 试验对就业、幸福感的因果效应。',
    whyHard='政治意愿和资金。',
...
add(
    id='terrorism', category='social',
    title='恐怖主义根源', titleEn='Root Causes of Terrorism',
    year=2001, proposer='—', difficulty=4, reward=0, status='open',
    summary='理解恐怖主义的根源',
    kid='9/11 后反恐花了几万亿，但恐怖主义没消失。研究发现关键不是"贫穷"而是"政治机会和个人意义"。',
    formal='> 显著降低全球恐怖袭击数。',
    whyHard='多维、跨国。',
    aiPrompt='介绍 Crenshaw、global terrorism database。',
    tags=['社会', '政治', '安全'],
    videoUrl='https://www.youtube.com/embed/feature_video_placeholder', videoTitle='Terrorism', videoChannel='Kurzgesagt',
    participate=part(('essay','介绍恐怖主义研究'),
                  ('discuss','参与讨论'))
)

add(
    id='drug-policy', category='social',
    title='毒品政策改革', titleEn='Drug Policy Reform',
    year=1971, proposer='R. Nixon', difficulty=3, reward=0, status='open',
    summary='从"禁毒"到"减害"',
    kid='美国 1971 年尼克松发起"禁毒战争"，但毒品问题更糟了。葡萄牙 2001 年将毒品去罪化，结果吸毒和犯罪都下降。',
    formal='> 全球毒品相关犯罪和死亡显著下降。',
    whyHard='政治意愿。',
    aiPrompt='介绍 Portugal model、harm reduction。',
    tags=['社会', '政策', '健康'],
    videoUrl='https://www.youtube.com/embed/feature_video_placeholder', videoTitle='Drug Policy', videoChannel='Kurzgesagt',
    participate=part(('essay','介绍各国毒品政策'),
                  ('discuss','参与讨论'))
)

add(
    id='criminal-justice', category='social',
    title='刑事司法改革', titleEn='Criminal Justice Reform',
    year=2000, proposer='—', difficulty=3, reward=0, status='open',
    summary='减少监禁、增加改造',
    kid='美国监禁率全球最高（每 10 万人 629 人）。70% 犯人出狱后 5 年内再犯。怎么减少监禁率同时降低再犯率？',
    formal='> 监禁率 < 150/10 万、再犯率 < 30%。',
    whyHard='政治意愿。',
    aiPrompt='介绍 Norway 监狱、Brennan Center。',
    tags=['社会', '法', '政策'],
    videoUrl='https://www.youtube.com/embed/feature_video_placeholder', videoTitle='Justice Reform', videoChannel='Kurzgesagt',
    participate=part(('essay','介绍挪威监狱模式'),
                  ('community','参与公益法律援助'))
)
...
add(
    id='indigenous-rights', category='social',
    title='原住民权利', titleEn='Indigenous Rights',
    year=2007, proposer='UN Declaration', difficulty=2, reward=0, status='open',
    summary='保护原住民文化与权利',
    kid='全球 4.76 亿原住民占世界人口 6% 但占贫困人口 15%。他们的土地、传统知识、文化面临严重威胁。',
    formal='> 全球原住民生命权、土地权、知情同意权得到保障。',
    whyHard='国家主权与文化多元的张力。',
    aiPrompt='介绍 UNDRIP、FPIC。',
    tags=['社会', '人权', '文化'],
    videoUrl='https://www.youtube.com/embed/feature_video_placeholder', videoTitle='Indigenous', videoChannel='Kurzgesagt',
    participate=part(('essay','介绍 UNDRIP'),
                  ('community','参与志愿活动'))
)
