...
export default {
  ...
  collab: {
    ...
    roadmap: '路线图',
    teams: '团队',
    teamsSubtitle: '和志同道合的解题者组队，贡献汇聚、积分共享',
    teamsFor: '为这道问题组建的团队',
    teamsCount: '个团队',
    selectProblem: '选择一个问题',
    chooseProblem: '请选择问题',
    pickProblemFirst: '请先在上方选择一个问题',
    startDiscussion: '发起一个新讨论…',
    post: '发送',
    reply: '回复',
    ...
    downvote: '点踩',
    edited: '已编辑',
    noDiscussions: '还没有讨论 — 来开个头吧！',
    loginRequired: '请先登录',
    loginToDiscuss: '登录后可以参与讨论',
    loginToContribute: '登录后可以贡献路线图条目',
    confirmDelete: '确定要删除吗？此操作不可撤销。',
    roadmapSubtitle: '记录这个问题的研究/突破时间线 — 提议、探索、进行中、突破、受阻、完成',
    roadmapTitlePlaceholder: '进展标题（例如 2026 Q3: 综述调研）',
    roadmapDescPlaceholder: '可选描述',
    addEntry: '添加条目',
    noRoadmap: '暂无路线图条目',
    createTeam: '创建团队',
    teamNamePlaceholder: '团队名称（同一问题下唯一）',
    teamDescPlaceholder: '团队介绍（可选）',
    create: '创建',
    noTeamsYet: '还没有团队',
    beFirstToCreate: '要不要创建第一个？',
    leader: '队长',
    member: '成员',
    members: '成员',
    joinTeam: '加入团队',
    confirmLeave: '确定要离开这个团队？',
    confirmDisband: '确定要解散这个团队？此操作不可撤销！',
    disband: '解散',
    leaveTeam: '离开',
    contributions: '成员贡献',
    noContributions: '还没有贡献记录',
    solutions: '解答数',
    score: '积分',
    teamNotFound: '团队不存在或已解散',
    backToTeams: '返回团队列表',
    youAreLeader: '你是队长',
    youAreMember: '你是成员'
  },
